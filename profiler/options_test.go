...
func TestOptions(t *testing.T) {
	...
	t.Run("WithAgentAddr/override", func(t *testing.T) {
		os.Setenv("POBP_AGENT_HOST", "bad_host")
		defer os.Unsetenv("POBP_AGENT_HOST")
		os.Setenv("POBP_TRACE_AGENT_PORT", "bad_port")
		defer os.Unsetenv("POBP_TRACE_AGENT_PORT")
		var cfg config
		WithAgentAddr("test:123")(&cfg)
		expectedURL := "http://test:123/profiling/v1/input"
		assert.Equal(t, expectedURL, cfg.agentURL)
	...
	t.Run("WithAPIKey/override", func(t *testing.T) {
		os.Setenv("POBP_API_KEY", "apikey")
		defer os.Unsetenv("POBP_API_KEY")
	...
	t.Run("WithService/override", func(t *testing.T) {
		os.Setenv("POBP_SERVICE", "envService")
	...
	t.Run("WithSite/override", func(t *testing.T) {
		os.Setenv("POBP_SITE", "wrong.site")
		defer os.Unsetenv("POBP_SITE")
		cfg, err := defaultConfig()
		require.NoError(t, err)
		WithSite("datadog.eu")(cfg)
		assert.Equal(t, "https://intake.profile.datadog.eu/v1/input", cfg.apiURL)
	...
	t.Run("WithVersion/override", func(t *testing.T) {
		os.Setenv("POBP_VERSION", "envVersion")
	...
	t.Run("WithTags/override", func(t *testing.T) {
		os.Setenv("POBP_TAGS", "env1:tag1,env2:tag2")
...
func TestEnvVars(t *testing.T) {
	t.Run("POBP_AGENT_HOST", func(t *testing.T) {
		os.Setenv("POBP_AGENT_HOST", "agent_host_1")
		defer os.Unsetenv("POBP_AGENT_HOST")
		cfg, err := defaultConfig()
		require.NoError(t, err)
	...
	t.Run("POBP_TRACE_AGENT_PORT", func(t *testing.T) {
		os.Setenv("POBP_TRACE_AGENT_PORT", "6218")
		defer os.Unsetenv("POBP_TRACE_AGENT_PORT")
		cfg, err := defaultConfig()
		require.NoError(t, err)
	...
	t.Run("POBP_PROFILING_UPLOAD_TIMEOUT", func(t *testing.T) {
		os.Setenv("POBP_PROFILING_UPLOAD_TIMEOUT", "3s")
		defer os.Unsetenv("POBP_PROFILING_UPLOAD_TIMEOUT")
		cfg, err := defaultConfig()
		require.NoError(t, err)
		assert.Equal(t, 3*time.Second, cfg.uploadTimeout)
	})

	t.Run("POBP_AGENT_HOST+POBP_TRACE_AGENT_PORT", func(t *testing.T) {
		os.Setenv("POBP_AGENT_HOST", "agent_host_1")
		defer os.Unsetenv("POBP_AGENT_HOST")
		os.Setenv("POBP_TRACE_AGENT_PORT", "6218")
		defer os.Unsetenv("POBP_TRACE_AGENT_PORT")
	...
	t.Run("POBP_API_KEY", func(t *testing.T) {
		os.Setenv("POBP_API_KEY", testAPIKey)
		defer os.Unsetenv("POBP_API_KEY")
		cfg, err := defaultConfig()
		require.NoError(t, err)
		assert.Equal(t, testAPIKey, cfg.apiKey)
	...
	t.Run("POBP_SITE", func(t *testing.T) {
		os.Setenv("POBP_SITE", "datadog.eu")
		defer os.Unsetenv("POBP_SITE")
		cfg, err := defaultConfig()
		require.NoError(t, err)
		assert.Equal(t, "https://intake.profile.datadog.eu/v1/input", cfg.apiURL)
	...
	t.Run("POBP_ENV", func(t *testing.T) {
		os.Setenv("POBP_ENV", "someEnv")
		defer os.Unsetenv("POBP_ENV")
		cfg, err := defaultConfig()
		require.NoError(t, err)
	...
	t.Run("POBP_SERVICE", func(t *testing.T) {
		os.Setenv("POBP_SERVICE", "someService")
		defer os.Unsetenv("POBP_SERVICE")
		cfg, err := defaultConfig()
		require.NoError(t, err)
	...
	t.Run("POBP_VERSION", func(t *testing.T) {
	...
	t.Run("POBP_TAGS", func(t *testing.T) {
		os.Setenv("POBP_TAGS", "a:1,b:2,c:3")
		defer os.Unsetenv("POBP_TAGS")
		cfg, err := defaultConfig()
		require.NoError(t, err)
		assert.Contains(t, cfg.tags, "a:1")
	...
	t.Run("POBP_PROFILING_DELTA", func(t *testing.T) {
		os.Setenv("POBP_PROFILING_DELTA", "false")
		defer os.Unsetenv("POBP_PROFILING_DELTA")
		cfg, err := defaultConfig()
		require.NoError(t, err)
...
func TestWith_outputDir(t *testing.T) {
	...
	os.Setenv("POBP_PROFILING_OUTPUT_DIR", tmpDir)
	defer os.Unsetenv("POBP_PROFILING_OUTPUT_DIR")
