...
func SetTags(span pobptrace.Span, tags map[string]interface{}) {
	for k, v := range tags {
		span.SetTag(k, v)
	}
}
...
func SetEventSpanTags(span pobptrace.Span, events []json.RawMessage) error {
	...
	span.SetTag("_pobp.origin", "appsec")
