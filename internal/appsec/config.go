...
const (
	enabledEnvVar         = "POBP_APPSEC_ENABLED"
	rulesEnvVar           = "POBP_APPSEC_RULES"
	wafTimeoutEnvVar      = "POBP_APPSEC_WAF_TIMEOUT"
	traceRateLimitEnvVar  = "POBP_APPSEC_TRACE_RATE_LIMIT"
	obfuscatorKeyEnvVar   = "POBP_APPSEC_OBFUSCATION_PARAMETER_KEY_REGEXP"
	obfuscatorValueEnvVar = "POBP_APPSEC_OBFUSCATION_PARAMETER_VALUE_REGEXP"
)
...
type config struct {
	// rules loaded via the env var POBP_APPSEC_RULES. When not set, the builtin rules will be used.
	rules []byte
...
// POBP_APPSEC_ENABLED is set to true.
