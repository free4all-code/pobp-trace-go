...
import (
	...
	grpctrace "git.proto.group/protoobp/pobp-trace-go/contrib/google.golang.org/grpc"
	...
	pb "git.proto.group/protoobp/pobp-trace-go/internal/traceprof/testapp"
...
func (a *App) Work(ctx context.Context, req *pb.WorkReq) (*pb.WorkRes, error) {
	...
	// finishing.
	var cpuSpan, decoySpan pobptrace.Span
	if a.config.ChildOf {
