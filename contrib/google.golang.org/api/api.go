...
package api // import "git.proto.group/protoobp/pobp-trace-go/contrib/google.golang.org/api"
...
import (
	...
	"git.proto.group/protoobp/pobp-trace-go/contrib/google.golang.org/api/internal"
...
func WrapRoundTripper(transport http.RoundTripper, options ...Option) http.RoundTripper {
	...
	rtOpts := []httptrace.RoundTripperOption{
		httptrace.WithBefore(func(req *http.Request, span pobptrace.Span) {
