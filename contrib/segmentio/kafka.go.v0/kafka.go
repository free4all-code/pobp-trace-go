...
func (r *Reader) startSpan(ctx context.Context, msg *kafka.Message) pobptrace.Span {
...
func (w *Writer) startSpan(ctx context.Context, msg *kafka.Message) pobptrace.Span {
	opts := []tracer.StartSpanOption{
...
func finishSpan(span pobptrace.Span, partition int, offset int64, err error) {
