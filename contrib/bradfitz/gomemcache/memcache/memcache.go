...
package memcache // import "git.proto.group/protoobp/pobp-trace-go/contrib/bradfitz/gomemcache/memcache"
...
func (c *Client) startSpan(resourceName string) pobptrace.Span {
