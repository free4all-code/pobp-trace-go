...
package mgo // import "git.proto.group/protoobp/pobp-trace-go/contrib/globalsign/mgo"
...
func newChildSpanFromContext(cfg *mongoConfig, tags map[string]string) pobptrace.Span {
