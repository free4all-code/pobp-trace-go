...
func defaults(cfg *config) {
	if internal.BoolEnv("POBP_TRACE_HTTP_ANALYTICS_ENABLED", false) {
	...
	cfg.spanOpts = []pobptrace.StartSpanOption{tracer.Measured()}
...
// WithSpanOptions defines a set of additional pobptrace.StartSpanOption to be added
...
// RoundTrip is made.
type RoundTripperBeforeFunc func(*http.Request, pobptrace.Span)
...
type RoundTripperAfterFunc func(*http.Response, pobptrace.Span)
...
// RTWithSpanOptions defines a set of additional pobptrace.StartSpanOption to be added
// to spans started by the integration.
func RTWithSpanOptions(opts ...pobptrace.StartSpanOption) RoundTripperOption {
	return func(cfg *roundTripperConfig) {
		cfg.spanOpts = append(cfg.spanOpts, opts...)
	}
}
