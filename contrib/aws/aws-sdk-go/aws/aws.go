...
package aws // import "git.proto.group/protoobp/pobp-trace-go/contrib/aws/aws-sdk-go/aws"
...
func WrapSession(s *session.Session, opts ...Option) *session.Session {
	...
	s.Handlers.Send.PushFrontNamed(request.NamedHandler{
		Name: "git.proto.group/protoobp/pobp-trace-go/contrib/aws/aws-sdk-go/aws/handlers.Send",
		Fn:   h.Send,
	})
	s.Handlers.Complete.PushBackNamed(request.NamedHandler{
		Name: "git.proto.group/protoobp/pobp-trace-go/contrib/aws/aws-sdk-go/aws/handlers.Complete",
		Fn:   h.Complete,
	})
	return s
}
