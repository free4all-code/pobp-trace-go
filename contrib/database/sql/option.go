...
func defaults(cfg *config) {
	...
	if internal.BoolEnv("POBP_TRACE_SQL_ANALYTICS_ENABLED", false) {
		cfg.analyticsRate = 1.0
	} else {
		cfg.analyticsRate = math.NaN()
	}
	cfg.commentInjectionMode = tracer.SQLCommentInjectionMode(os.Getenv("POBP_TRACE_SQL_COMMENT_INJECTION_MODE"))
}
