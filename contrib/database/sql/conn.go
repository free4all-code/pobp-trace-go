package sql // import "git.proto.group/protoobp/pobp-trace-go/contrib/database/sql"
...
func injectComments(ctx context.Context, query string, mode tracer.SQLCommentInjectionMode) (cquery string, spanID uint64) {
	...
	// gets created.
	var spanCtx pobptrace.SpanContext
...
func (tp *traceParams) tryTrace(ctx context.Context, qtype queryType, query string, startTime time.Time, err error, spanOpts ...pobptrace.StartSpanOption) {
