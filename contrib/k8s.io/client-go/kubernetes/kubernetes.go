...
package kubernetes // import "git.proto.group/protoobp/pobp-trace-go/contrib/k8s.io/client-go/kubernetes"
...
func wrapRoundTripperWithOptions(rt http.RoundTripper, opts ...httptrace.RoundTripperOption) http.RoundTripper {
	opts = append(opts, httptrace.WithBefore(func(req *http.Request, span pobptrace.Span) {
