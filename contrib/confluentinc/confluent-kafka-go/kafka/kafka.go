...
package kafka // import "git.proto.group/protoobp/pobp-trace-go/contrib/confluentinc/confluent-kafka-go/kafka"
...
func (c *Consumer) startSpan(msg *kafka.Message) pobptrace.Span {
...
func (p *Producer) startSpan(msg *kafka.Message) pobptrace.Span {
	opts := []tracer.StartSpanOption{
