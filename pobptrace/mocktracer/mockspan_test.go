...
func basicSpan(operationName string) *mockspan {
	return newSpan(&mocktracer{}, operationName, &pobptrace.StartSpanConfig{})
}
...
func TestNewSpan(t *testing.T) {
	...
	t.Run("options", func(t *testing.T) {
		...
		opts := &pobptrace.StartSpanConfig{
			StartTime: startTime,
			Tags:      tags,
		}
	...
	t.Run("parent", func(t *testing.T) {
		...
		opts := &pobptrace.StartSpanConfig{Parent: parentctx}
...
func TestSpanStartTime(t *testing.T) {
	startTime := time.Now()
	s := newSpan(&mocktracer{}, "http.request", &pobptrace.StartSpanConfig{StartTime: startTime})
...
func TestSpanContext(t *testing.T) {
	...
	t.Run("IDs", func(t *testing.T) {
		...
		child := newSpan(&mocktracer{}, "db.query", &pobptrace.StartSpanConfig{
