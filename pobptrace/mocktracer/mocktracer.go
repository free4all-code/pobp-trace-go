...
var _ pobptrace.Tracer = (*mocktracer)(nil)
...
func (t *mocktracer) StartSpan(operationName string, opts ...pobptrace.StartSpanOption) pobptrace.Span {
	var cfg pobptrace.StartSpanConfig
	for _, fn := range opts {
		fn(&cfg)
	}
...
func (t *mocktracer) Extract(carrier interface{}) (pobptrace.SpanContext, error) {
...
func (t *mocktracer) Inject(context pobptrace.SpanContext, carrier interface{}) error {
