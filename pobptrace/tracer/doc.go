...
// Package tracer contains Proto OBP core tracing client. It is used to trace
...
//   defer tracer.Stop()
//
// Sampling rules can also be configured at runtime using the POBP_TRACE_SAMPLING_RULES
...
//    export POBP_TRACE_SAMPLING_RULES='[{"name": "web.request", "sample_rate": 1.0}]'
//
...
// visualize.
//
// See the contrib package 
// for integrating POBP with various libraries, frameworks and clients.
//
...
// https://godoc.org/git.proto.group/protoobp/pobp-trace-go/contrib
package tracer // import "git.proto.group/protoobp/pobp-trace-go/pobptrace/tracer"
