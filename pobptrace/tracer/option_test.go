...
func TestAutoDetectStatsd(t *testing.T) {
	...
	t.Run("env", func(t *testing.T) {
		defer func(old string) { os.Setenv("POBP_DOGSTATSD_PORT", old) }(os.Getenv("POBP_DOGSTATSD_PORT"))
		os.Setenv("POBP_DOGSTATSD_PORT", "8111")
...
func TestLoadAgentFeatures(t *testing.T) {
	...
	t.Run("discovery", func(t *testing.T) {
		defer func(old string) { os.Setenv("POBP_TRACE_FEATURES", old) }(os.Getenv("POBP_TRACE_FEATURES"))
		os.Setenv("POBP_TRACE_FEATURES", "discovery")
		srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
...
func TestTracerOptionsDefaults(t *testing.T) {
	...
	t.Run("analytics", func(t *testing.T) {
		...
		t.Run("env/on", func(t *testing.T) {
			os.Setenv("POBP_TRACE_ANALYTICS_ENABLED", "true")
			defer os.Unsetenv("POBP_TRACE_ANALYTICS_ENABLED")
			defer globalconfig.SetAnalyticsRate(math.NaN())
			newConfig()
		...
		t.Run("env/off", func(t *testing.T) {
			os.Setenv("POBP_TRACE_ANALYTICS_ENABLED", "kj12")
			defer os.Unsetenv("POBP_TRACE_ANALYTICS_ENABLED")
			defer globalconfig.SetAnalyticsRate(math.NaN())
			newConfig()
	...
	t.Run("dogstatsd", func(t *testing.T) {
		...
		t.Run("env-host", func(t *testing.T) {
			os.Setenv("POBP_AGENT_HOST", "my-host")
			defer os.Unsetenv("POBP_AGENT_HOST")
			tracer := newTracer()
			c := tracer.config
		...
		t.Run("env-port", func(t *testing.T) {
			os.Setenv("POBP_DOGSTATSD_PORT", "123")
			defer os.Unsetenv("POBP_DOGSTATSD_PORT")
			tracer := newTracer()
			c := tracer.config
		...
		t.Run("env-env", func(t *testing.T) {
			os.Setenv("POBP_ENV", "testEnv")
			defer os.Unsetenv("POBP_ENV")
			tracer := newTracer()
			c := tracer.config
	...
	t.Run("env-agentAddr", func(t *testing.T) {
		os.Setenv("POBP_AGENT_HOST", "trace-agent")
		defer os.Unsetenv("POBP_AGENT_HOST")
		tracer := newTracer()
		c := tracer.config
	...
	t.Run("trace_enabled", func(t *testing.T) {
		...
		t.Run("override", func(t *testing.T) {
			os.Setenv("POBP_TRACE_ENABLED", "false")
			defer os.Unsetenv("POBP_TRACE_ENABLED")
			tracer := newTracer()
			c := tracer.config
	...
	t.Run("env-tags", func(t *testing.T) {
		os.Setenv("POBP_TAGS", "env:test, aKey:aVal,bKey:bVal, cKey:")
		defer os.Unsetenv("POBP_TAGS")
	...
	t.Run("env-mapping", func(t *testing.T) {
		os.Setenv("POBP_SERVICE_MAPPING", "tracer.test:test2, svc:Newsvc,http.router:myRouter, noval:")
		defer os.Unsetenv("POBP_SERVICE_MAPPING")
	...
	t.Run("datadog-tags", func(t *testing.T) {
		t.Run("can-set-value", func(t *testing.T) {
			os.Setenv("POBP_TRACE_X_DATADOG_TAGS_MAX_LENGTH", "200")
			defer os.Unsetenv("POBP_TRACE_X_DATADOG_TAGS_MAX_LENGTH")
			assert := assert.New(t)
			c := newConfig()
		...
		t.Run("clamped-to-zero", func(t *testing.T) {
			os.Setenv("POBP_TRACE_X_DATADOG_TAGS_MAX_LENGTH", "-520")
			defer os.Unsetenv("POBP_TRACE_X_DATADOG_TAGS_MAX_LENGTH")
			assert := assert.New(t)
			c := newConfig()
			p := c.propagator.(*chainedPropagator).injectors[0].(*propagator)
		...
		t.Run("upper-clamp", func(t *testing.T) {
			os.Setenv("POBP_TRACE_X_DATADOG_TAGS_MAX_LENGTH", "1000")
			defer os.Unsetenv("POBP_TRACE_X_DATADOG_TAGS_MAX_LENGTH")
			assert := assert.New(t)
			c := newConfig()
			p := c.propagator.(*chainedPropagator).injectors[0].(*propagator)
...
func TestDefaultDogstatsdAddr(t *testing.T) {
	...
	t.Run("socket", func(t *testing.T) {
		defer func(old string) { os.Setenv("POBP_AGENT_HOST", old) }(os.Getenv("POBP_AGENT_HOST"))
		defer func(old string) { os.Setenv("POBP_DOGSTATSD_PORT", old) }(os.Getenv("POBP_DOGSTATSD_PORT"))
		os.Unsetenv("POBP_AGENT_HOST")
		os.Unsetenv("POBP_DOGSTATSD_PORT")
		f, err := ioutil.TempFile("", "dsd.socket")
		if err != nil {
			t.Fatal(err)
		}
...
func TestServiceName(t *testing.T) {
	...
	t.Run("env", func(t *testing.T) {
		defer globalconfig.SetServiceName("")
		os.Setenv("POBP_SERVICE", "api-intake")
		defer os.Unsetenv("POBP_SERVICE")
		assert := assert.New(t)
		c := newConfig()
	...
	t.Run("POBP_TAGS", func(t *testing.T) {
		defer globalconfig.SetServiceName("")
		os.Setenv("POBP_TAGS", "service:api-intake")
		defer os.Unsetenv("POBP_TAGS")
		assert := assert.New(t)
		c := newConfig()
	...
	t.Run("override-chain", func(t *testing.T) {
		...
		os.Setenv("POBP_TAGS", "service:testService")
		defer os.Unsetenv("POBP_TAGS")
		globalconfig.SetServiceName("")
		c = newConfig()
		...
		os.Setenv("POBP_SERVICE", "testService3")
		defer os.Unsetenv("POBP_SERVICE")
		globalconfig.SetServiceName("")
		c = newConfig(WithGlobalTag("service", "testService2"))
...
func TestVersionConfig(t *testing.T) {
	...
	t.Run("env", func(t *testing.T) {
		os.Setenv("POBP_VERSION", "1.2.3")
		defer os.Unsetenv("POBP_VERSION")
		assert := assert.New(t)
		c := newConfig()
	...
	t.Run("POBP_TAGS", func(t *testing.T) {
		os.Setenv("POBP_TAGS", "version:1.2.3")
		defer os.Unsetenv("POBP_TAGS")
		assert := assert.New(t)
		c := newConfig()
	...
	t.Run("override-chain", func(t *testing.T) {
		...
		os.Setenv("POBP_TAGS", "version:1.1.1")
		defer os.Unsetenv("POBP_TAGS")
		c = newConfig()
...
func TestEnvConfig(t *testing.T) {
	...
	t.Run("POBP_TAGS", func(t *testing.T) {
		os.Setenv("POBP_TAGS", "env:testing")
		defer os.Unsetenv("POBP_TAGS")
		assert := assert.New(t)
		c := newConfig()
	...
	t.Run("override-chain", func(t *testing.T) {
		...
		os.Setenv("POBP_TAGS", "env:testing1")
		defer os.Unsetenv("POBP_TAGS")
		c = newConfig()
...
func TestWithHostname(t *testing.T) {
	...
	t.Run("env", func(t *testing.T) {
		assert := assert.New(t)
		os.Setenv("POBP_TRACE_SOURCE_HOSTNAME", "hostname-env")
		defer os.Unsetenv("POBP_TRACE_SOURCE_HOSTNAME")
		c := newConfig()
