...
func TestSpanLog(t *testing.T) {
	t.Run("default", func(t *testing.T) {
		...
		expect := fmt.Sprintf(`pobp.service=tracer.test pobp.trace_id="%d" pobp.span_id="%d"`, span.TraceID, span.SpanID)
	...
	t.Run("env", func(t *testing.T) {
		...
		defer stop()
		span := tracer.StartSpan("test.request").(*span)
		expect := fmt.Sprintf(`pobp.service=tracer.test pobp.env=testenv pobp.trace_id="%d" pobp.span_id="%d"`, span.TraceID, span.SpanID)
		assert.Equal(expect, fmt.Sprintf("%v", span))
	})
	...
	t.Run("version", func(t *testing.T) {
		...
		defer stop()
		span := tracer.StartSpan("test.request").(*span)
		expect := fmt.Sprintf(`pobp.service=tracer.test pobp.version=1.2.3 pobp.trace_id="%d" pobp.span_id="%d"`, span.TraceID, span.SpanID)
		assert.Equal(expect, fmt.Sprintf("%v", span))
	})
	...
	t.Run("full", func(t *testing.T) {
		...
		defer stop()
		span := tracer.StartSpan("test.request").(*span)
		expect := fmt.Sprintf(`pobp.service=tracer.test pobp.env=testenv pobp.version=1.2.3 pobp.trace_id="%d" pobp.span_id="%d"`, span.TraceID, span.SpanID)
		assert.Equal(expect, fmt.Sprintf("%v", span))
	})
	...
	t.Run("env", func(t *testing.T) {
		os.Setenv("POBP_SERVICE", "tracer.test")
	...
	t.Run("badformat", func(t *testing.T) {
		...
		defer stop()
		span := tracer.StartSpan("test.request").(*span)
		expect := fmt.Sprintf(`%%!b(pobptrace.Span=pobp.service=tracer.test pobp.version=1.2.3 pobp.trace_id="%d" pobp.span_id="%d")`, span.TraceID, span.SpanID)
