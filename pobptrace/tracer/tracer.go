...
var _ pobptrace.Tracer = (*tracer)(nil)
...
// Span is an alias for pobptrace.Span. It is here to allow godoc to group methods returning
// pobptrace.Span. It is recommended and is considered more correct to refer to this type as
// pobptrace.Span instead.
type Span = pobptrace.Span
...
// If the tracer is not started, calling this function is a no-op.
func Extract(carrier interface{}) (pobptrace.SpanContext, error) {
...
// If the tracer is not started, calling this function is a no-op.
func Inject(ctx pobptrace.SpanContext, carrier interface{}) error {
...
func newUnstartedTracer(opts ...StartOption) *tracer {
	...
	if err != nil {
		log.Warn("DIAGNOSTICS Error(s) parsing POBP_TRACE_SAMPLING_RULES: %s", err)
	}
	if envRules != nil {
...
func (t *tracer) StartSpan(operationName string, options ...pobptrace.StartSpanOption) pobptrace.Span {
	var opts pobptrace.StartSpanConfig
...
func (t *tracer) Inject(ctx pobptrace.SpanContext, carrier interface{}) error {
	return t.config.propagator.Inject(ctx, carrier)
}

// Extract uses the configured or default TextMap Propagator.
func (t *tracer) Extract(carrier interface{}) (pobptrace.SpanContext, error) {
