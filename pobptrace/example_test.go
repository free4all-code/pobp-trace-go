...
// our native POBP APM tracing client integration. For thorough documentation
...
// The below example illustrates how to set up an opentracing.Tracer using POBP's
// tracer.
func Example_opentracing() {
	// Start a POBP tracer, optionally providing a set of options,
	...
	// Use it with the Opentracing API. The (already started) POBP tracer
